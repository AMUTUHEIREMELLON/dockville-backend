const Validate = () => {
  let firstName = document.taxi.firstname;
  let lastName = document.taxi.lastname;
  let model = document.taxi.model;
  let numberPlate = document.taxi.numberplate;
  let color = document.taxi.color;
  let date = document.taxi.date;
  let time = document.taxi.time;
  let slotnumber = document.taxi.slotnumber;
