const Validate = () => {
  let firstName = document.coaster.firstname;
  let lastName = document.coaster.lastname;
  let model = document.coaster.model;
  let numberPlate = document.coaster.numberplate;
  let color = document.coaster.color;
  let date = document.coaster.date;
  let time = document.coaster.time;
  let slotnumber = document.coaster.slotnumber;
